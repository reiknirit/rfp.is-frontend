...
(function($PS) {
  ...
  var routeCodec = Routing_Duplex.root(Routing_Duplex_Generic.sum(genericRoute)(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
      return "Home";
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Component.Button"] = $PS["Component.Button"] || {};
  var exports = $PS["Component.Button"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Maybe = $PS["Data.Maybe"];
...
(function($PS) {
  ...
  var Component_Button = $PS["Component.Button"];
  var Data_Function = $PS["Data.Function"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Ord = $PS["Data.Ord"];
  var Data_Symbol = $PS["Data.Symbol"];
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Button") ]), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "button";
          }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Component_Button.component)(Data_Unit.unit)(Data_Void.absurd) ]);
      };
  ...
  var component = function (dictMonadAff) {
      return function (dictNavigate) {
          var render = function (v) {
              ...
              throw new Error("Failed pattern match at Component.Router (line 62, column 22 - line 66, column 59): " + [ v.route.constructor.name ]);
          };
          var handleQuery = function (v) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Route.eqRoute))(v1.route)(new Data_Maybe.Just(v.value0)))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $16.route = new Data_Maybe.Just(v.value0);
                      return $16;
                  })))(function () {
          ...
          var handleAction = function (v) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)((function () {
                  var $24 = Routing_Duplex.parse(Data_Route.routeCodec);
                  return function ($25) {
                      return Data_Either.hush($24($25));
                  };
