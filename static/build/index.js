...
(function($PS) {
  ...
  var genericRoute = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Data.Route (line 14, column 1 - line 14, column 48): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var routeCodec = Routing_Duplex.root(Routing_Duplex_Generic.sum(genericRoute)(Routing_Duplex_Generic.gRouteSum(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
      ...
      Submission: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("submission")(Routing_Duplex_Generic.noArgs)
  }));   
  var eqRoute = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof Submission && y instanceof Submission) {
              return true;
          };
          return false;
      };
...
(function($PS) {
  ...
  var valColor = new Val((function () {
      var $105 = CSS_String.fromString(isStringValue);
      return function ($106) {
          return $105(Color.cssStringHSLA($106));
      };
  })());
...
(function($PS) {
  ...
  exports["centerValue"] = centerValue;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["CSS.ListStyle.Type"] = $PS["CSS.ListStyle.Type"] || {};
  var exports = $PS["CSS.ListStyle.Type"];
  var CSS_Property = $PS["CSS.Property"];
  var CSS_String = $PS["CSS.String"];
  var CSS_Stylesheet = $PS["CSS.Stylesheet"];      
  var Disc = (function () {
...
(function($PS) {
  ...
  var predicate = function (v) {
      ...
      throw new Error("Failed pattern match at CSS.Render (line 174, column 1 - line 174, column 33): " + [ v.constructor.name ]);
  };
  var selector$prime$prime = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at CSS.Render (line 140, column 1 - line 140, column 63): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var merger = function (v) {
      ...
      throw new Error("Failed pattern match at CSS.Render (line 167, column 3 - line 172, column 105): " + [ v.value0.constructor.name ]);
  };
  ...
  var mediaQuery = function (v) {
      return "@media " + (mediaType(v.value1) + Data_NonEmpty.foldl1(Data_Foldable.foldableArray)(Data_Semigroup.append(Data_Semigroup.semigroupString))(Data_Functor.map(Data_NonEmpty.functorNonEmpty(Data_Functor.functorArray))(function ($173) {
          return (function (v1) {
              return " and " + v1;
          })(feature($173));
      })(v.value2)));
  ...
  var collect$prime = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at CSS.Render (line 155, column 1 - line 155, column 80): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Form.Error"] = $PS["Form.Error"] || {};
  var exports = $PS["Form.Error"];                     
  ...
  var InvalidNumber = (function () {
      function InvalidNumber(value0) {
          this.value0 = value0;
      };
      InvalidNumber.create = function (value0) {
          return new InvalidNumber(value0);
      };
      return InvalidNumber;
  })();
  var InvalidDateTime = (function () {
      function InvalidDateTime(value0) {
          this.value0 = value0;
      };
      InvalidDateTime.create = function (value0) {
          return new InvalidDateTime(value0);
      };
      return InvalidDateTime;
  })();     
  var errorToString = function (error) {
      if (error instanceof Required) {
          return "This field is required";
      };
      if (error instanceof Invalid) {
          return "This field is invalid";
      };
      if (error instanceof InvalidInt) {
          return "Value is not an integer";
      };
      if (error instanceof InvalidNumber) {
          return "Value is not a number";
      };
      if (error instanceof InvalidDateTime) {
          return "DateTime is not valid";
      };
      throw new Error("Failed pattern match at Form.Error (line 20, column 23 - line 25, column 49): " + [ error.constructor.name ]);
  };
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Data.Submission"] = $PS["Data.Submission"] || {};
  var exports = $PS["Data.Submission"];
  var Data_Eq = $PS["Data.Eq"];
  var Formless_Class_Initial = $PS["Formless.Class.Initial"];
  var initialSubmissionId = new Formless_Class_Initial.Initial(0);
  var eqSubmissionId = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x === y;
      };
  });
  exports["eqSubmissionId"] = eqSubmissionId;
  exports["initialSubmissionId"] = initialSubmissionId;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Form.Validation"] = $PS["Form.Validation"] || {};
  var exports = $PS["Form.Validation"];
  var Data_Either = $PS["Data.Either"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_String_Common = $PS["Data.String.Common"];
  var Form_Error = $PS["Form.Error"];
  var Formless_Validation = $PS["Formless.Validation"];                
  var validateStrMaybe = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (str) {
          var $2 = Data_String_Common["null"](str);
          if ($2) {
              return Data_Either.Right.create(Data_Maybe.Nothing.value);
          };
          return Data_Either.Right.create(new Data_Maybe.Just(str));
      });
  };
  var validateStr = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (str) {
          var $3 = Data_String_Common["null"](str);
          if ($3) {
              return new Data_Either.Left(Form_Error.Required.value);
          };
          return new Data_Either.Right(str);
      });
  };
  exports["validateStr"] = validateStr;
  exports["validateStrMaybe"] = validateStrMaybe;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
          ...
          return function (dictCons) {
              return function (sym) {
                  return function (f) {
                      return Data_Variant.inj()(new Data_Symbol.IsSymbol(function () {
                          return "modify";
                      }))(Data_Symbol.SProxy.value)(Data_Newtype.wrap(dictNewtype)(Data_Variant.inj()(dictIsSymbol)(sym)(Data_Newtype.wrap(Formless_Types_Form.newtypeInputFunction)(f))));
                  };
              };
          };
      };
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Halogen.Media.Component.CSS.Upload"] = $PS["Halogen.Media.Component.CSS.Upload"] || {};
  var exports = $PS["Halogen.Media.Component.CSS.Upload"];
  ...
  var uploads = CSS_Stylesheet.select(CSS_String.fromString(CSS_Selector.isStringSelector)(".uploads"))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.flexWrap(CSS_Flexbox.wrap))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.px(0.0)))(function () {
                  return CSS_Geometry.left(CSS_Size.px(0.0));
              });
          });
      });
  }));                                                                                                                                                       
  var uploadThumbnail = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_String.fromString(CSS_Selector.isStringSelector)(".upload-thumbnail"))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.justifyContent(CSS_Common.center(CSS_Common.centerValue)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.alignItems(CSS_Common.center(CSS_Common.centerValue)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
                  return CSS_Geometry.height(CSS_Size.px(200.0));
              });
          });
      });
  })))(function () {
      return CSS_Stylesheet.select(CSS_String.fromString(CSS_Selector.isStringSelector)(".upload-thumbnail > img"))(CSS_Geometry.width(CSS_Size.pct(100.0)));
  });
  var uploadInfo = (function () {
      var px = CSS_Size.px(0.0);
      return CSS_Stylesheet.select(CSS_String.fromString(CSS_Selector.isStringSelector)(".upload-info"))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.maxWidth(CSS_Size.pct(100.0)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.margin(px)(px)(px)(px))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.padding(px)(px)(px)(px))(function () {
                  return CSS_ListStyle_Type.listStyleType(CSS_ListStyle_Type.None.value);
              });
          });
      }));
  })();
  var uploadFile = (function () {
      var md = CSS_Size.px(25.0);
      return CSS_Stylesheet.select(CSS_String.fromString(CSS_Selector.isStringSelector)(".upload-file"))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.margin(md)(md)(md)(md))(function () {
          return CSS_Geometry.width(CSS_Size.px(200.0));
      }));
  })();
  var uploadContainer = CSS_Stylesheet.select(CSS_String.fromString(CSS_Selector.isStringSelector)(".upload-container"))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
      return CSS_Geometry.marginTop(CSS_Size.px(25.0));
  }));
  var dropbox = CSS_Stylesheet.select(CSS_String.fromString(CSS_Selector.isStringSelector)(".dropbox"))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.justifyContent(CSS_Common.center(CSS_Common.centerValue)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.alignItems(CSS_Common.center(CSS_Common.centerValue)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Border.border(CSS_Border.solid)(CSS_Size.px(0.5))(Color.rgb(0)(0)(0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.minHeight(CSS_Size.px(300.0)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginBottom(CSS_Size.px(25.0)))(function () {
                                  return CSS_Overflow.overflowY(CSS_Overflow.scroll);
                              });
                          });
                      });
                  });
  ...
  var stylesheet = Halogen_HTML_CSS.stylesheet(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(uploadContainer)(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(dropbox)(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(uploads)(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(uploadFile)(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(uploadInfo)(function () {
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Halogen.Media.Component.HTML.Utils"] = $PS["Halogen.Media.Component.HTML.Utils"] || {};
  var exports = $PS["Halogen.Media.Component.HTML.Utils"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];                
  var css = function ($0) {
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Halogen.Media.Data.File"] = $PS["Halogen.Media.Data.File"] || {};
  var exports = $PS["Halogen.Media.Data.File"];
  var ExtendedFile = (function () {
      function ExtendedFile(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      ExtendedFile.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new ExtendedFile(value0, value1, value2);
              };
          };
      };
      return ExtendedFile;
  ...
  var UploadFile = (function () {
      function UploadFile(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UploadFile.create = function (value0) {
          return function (value1) {
              return new UploadFile(value0, value1);
          };
      };
      return UploadFile;
  })();
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Halogen.Media.Utils"] = $PS["Halogen.Media.Utils"] || {};
  var exports = $PS["Halogen.Media.Utils"];
  var Data_Array = $PS["Data.Array"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Web_File_FileList = $PS["Web.File.FileList"];
  var fileListToFiles = function (fl) {
      if (fl instanceof Data_Maybe.Just) {
          var filesLen = Web_File_FileList.length(fl.value0) - 1 | 0;
          return Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)(function (x) {
              return Web_File_FileList.item(x)(fl.value0);
          })(Data_Array.range(0)(filesLen)));
      };
      if (fl instanceof Data_Maybe.Nothing) {
          return [  ];
      };
      throw new Error("Failed pattern match at Halogen.Media.Utils (line 23, column 22 - line 27, column 16): " + [ fl.constructor.name ]);
  };
  exports["fileListToFiles"] = fileListToFiles;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Halogen.Media.Component.Upload"] = $PS["Halogen.Media.Component.Upload"] || {};
  var exports = $PS["Halogen.Media.Component.Upload"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Except = $PS["Control.Monad.Except"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  ...
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var Halogen_Media_Component_CSS_Upload = $PS["Halogen.Media.Component.CSS.Upload"];
  var Halogen_Media_Component_HTML_Utils = $PS["Halogen.Media.Component.HTML.Utils"];
  var Halogen_Media_Data_File = $PS["Halogen.Media.Data.File"];
  var Halogen_Media_Utils = $PS["Halogen.Media.Utils"];
  var Halogen_Query_EventSource = $PS["Halogen.Query.EventSource"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Web_Event_Event = $PS["Web.Event.Event"];
  ...
  var DroppedFiles = (function () {
      function DroppedFiles(value0) {
          this.value0 = value0;
      };
      DroppedFiles.create = function (value0) {
          return new DroppedFiles(value0);
      };
      return DroppedFiles;
  })();
  var UploadFiles = (function () {
      function UploadFiles(value0) {
          this.value0 = value0;
      };
      UploadFiles.create = function (value0) {
          return new UploadFiles(value0);
      };
      return UploadFiles;
  })();
  var Initialize = (function () {
  ...
  var HandleFileUpload = (function () {
      function HandleFileUpload(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandleFileUpload.create = function (value0) {
          return function (value1) {
              return new HandleFileUpload(value0, value1);
          };
      };
      return HandleFileUpload;
  })();
  var SetFiles = (function () {
      function SetFiles(value0) {
          this.value0 = value0;
      };
      SetFiles.create = function (value0) {
          return new SetFiles(value0);
      };
      return SetFiles;
  })();
  var SubmitFiles = (function () {
      ...
      SubmitFiles.value = new SubmitFiles();
      return SubmitFiles;
  })();
  ...
  var setThumb = function (thumb) {
      return function (v) {
          return new Halogen_Media_Data_File.UploadFile(new Halogen_Media_Data_File.ExtendedFile(v.value0.value0, v.value0.value1, new Data_Maybe.Just(thumb)), v.value1);
      };
  }; 
  var component = function (dictMonadEffect) {
      return function (dictMonadAff) {
          var renderFile = function (v) {
              return Halogen_HTML_Elements.div([ Halogen_Media_Component_HTML_Utils.css("upload-file") ])([ Halogen_HTML_Elements.div([ Halogen_Media_Component_HTML_Utils.css("upload-thumbnail") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(Data_Maybe.fromMaybe("")(v.value0.value2)) ]) ]), Halogen_HTML_Elements.ul([ Halogen_Media_Component_HTML_Utils.css("upload-info") ])([ Halogen_HTML_Elements.li([ Halogen_Media_Component_HTML_Utils.css("upload-title") ])([ Halogen_HTML_Elements.b([  ])([ Halogen_HTML_Core.text("Name: ") ]), Halogen_HTML_Core.text(Web_File_File.name(v.value0.value0)) ]), Halogen_HTML_Elements.li([ Halogen_Media_Component_HTML_Utils.css("upload-size") ])([ Halogen_HTML_Elements.b([  ])([ Halogen_HTML_Core.text("Filesize: ") ]), Halogen_HTML_Core.text(Data_Show.show(Data_Show.showNumber)(Web_File_File.size(v.value0.value0))) ]), Halogen_HTML_Elements.li([ Halogen_Media_Component_HTML_Utils.css("upload-status upload-" + Data_Show.show(Data_Show.showBoolean)(v.value1)) ])([ Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.b([  ])([ Halogen_HTML_Core.text("Status: ") ]), (function () {
                  if (v.value1) {
                      return Halogen_HTML_Core.text("Completed");
                  };
                  if (!v.value1) {
                      return Halogen_HTML_Core.text("Pending");
                  };
                  throw new Error("Failed pattern match at Halogen.Media.Component.Upload (line 249, column 15 - line 251, column 41): " + [ v.value1.constructor.name ]);
              })() ]) ]) ]) ]);
          };
          var render = function (state) {
              return Halogen_HTML_Elements.div([ Halogen_Media_Component_HTML_Utils.css("upload-container") ])([ Halogen_Media_Component_CSS_Upload.stylesheet, Halogen_HTML_Elements.div([ Halogen_Media_Component_HTML_Utils.css("dropbox"), Halogen_HTML_Events.onDragOver(function (e) {
                  return Data_Maybe.Just.create(PreventDefault.create(Web_HTML_Event_DragEvent.toEvent(e)));
              }), Halogen_HTML_Events.onDrop(function (e) {
                  return Data_Maybe.Just.create(new SetFiles(e));
              }) ])([ (function () {
                  var $62 = Data_Array.length(state.files) <= 0;
                  if ($62) {
                      return Halogen_HTML_Core.text("Drop files here");
                  };
                  return Halogen_HTML_Core.text("");
              })(), Halogen_HTML_Elements.div([ Halogen_Media_Component_HTML_Utils.css("uploads") ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(state.files)(renderFile)) ]) ]);
          };
          var initialState = {
              files: [  ],
              reader: Data_Maybe.Nothing.value
          };
          var handleQuery = function (v) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var newArr = Data_Functor.map(Data_Functor.functorArray)(function (v2) {
                      var v3 = Data_Eq.eq(Data_UUID.eqUUID)(v2.value0.value1)(v.value0);
                      if (v3) {
                          return new Halogen_Media_Data_File.UploadFile(new Halogen_Media_Data_File.ExtendedFile(v2.value0.value0, v2.value0.value1, v2.value0.value2), v.value1);
                      };
                      if (!v3) {
                          return new Halogen_Media_Data_File.UploadFile(new Halogen_Media_Data_File.ExtendedFile(v2.value0.value0, v2.value0.value1, v2.value0.value2), v2.value1);
                      };
                      throw new Error("Failed pattern match at Halogen.Media.Component.Upload (line 149, column 11 - line 151, column 57): " + [ v3.constructor.name ]);
                  })(v1.files);
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      var $72 = {};
                      for (var $73 in v2) {
          ...
          var fileCallback = function (ev) {
              var eventTarget = Web_Event_Event.target(ev);
              if (eventTarget instanceof Data_Maybe.Just) {
                  var fileReader = Web_File_FileReader.fromEventTarget(eventTarget.value0);
                  if (fileReader instanceof Data_Maybe.Just) {
                      return Data_Maybe.Just.create(Web_File_FileReader.result(fileReader.value0));
                  };
                  if (fileReader instanceof Data_Maybe.Nothing) {
                      return Data_Maybe.Nothing.value;
                  };
                  throw new Error("Failed pattern match at Halogen.Media.Component.Upload (line 128, column 9 - line 130, column 29): " + [ fileReader.constructor.name ]);
              };
              if (eventTarget instanceof Data_Maybe.Nothing) {
                  return Data_Maybe.Nothing.value;
              };
              throw new Error("Failed pattern match at Halogen.Media.Component.Upload (line 125, column 5 - line 131, column 25): " + [ eventTarget.constructor.name ]);
          };
          var fileEventSource = function (fileReader) {
              return Halogen_Query_EventSource.eventListenerEventSource(dictMonadAff)(Web_HTML_Event_EventTypes.load)(Web_File_FileReader.toEventTarget(fileReader))(fileCallback);
          };
          var handleAction = function (v) {
              if (v instanceof Initialize) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              };
              if (v instanceof HandleFileUpload) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(v.value1))(function (v1) {
                      var thumbnail = Control_Monad_Except.runExcept(Foreign.readString(v1));
                      if (thumbnail instanceof Data_Either.Right) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                              var index = Data_Array.findIndex(function (v3) {
                                  return Data_Eq.eq(Data_UUID.eqUUID)(v3.value0.value1)(v.value0);
                              })(v2.files);
                              if (index instanceof Data_Maybe.Just) {
                                  var newArr = Data_Array.modifyAt(index.value0)(setThumb(thumbnail.value0))(v2.files);
                                  if (newArr instanceof Data_Maybe.Just) {
                                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                          ...
                                          $94.files = newArr.value0;
                                          return $94;
                                      });
                                  };
                                  if (newArr instanceof Data_Maybe.Nothing) {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                  };
                                  throw new Error("Failed pattern match at Halogen.Media.Component.Upload (line 170, column 15 - line 172, column 38): " + [ newArr.constructor.name ]);
                              };
                              if (index instanceof Data_Maybe.Nothing) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                              };
                              throw new Error("Failed pattern match at Halogen.Media.Component.Upload (line 167, column 11 - line 173, column 33): " + [ index.constructor.name ]);
                          });
                      };
                      if (thumbnail instanceof Data_Either.Left) {
                          return Effect_Class_Console.logShow(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Data_List_Types.showNonEmptyList(Foreign.showForeignError))(thumbnail.value0);
                      };
                      throw new Error("Failed pattern match at Halogen.Media.Component.Upload (line 163, column 7 - line 174, column 32): " + [ thumbnail.constructor.name ]);
                  });
              };
              if (v instanceof PreventDefault) {
                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(v.value0));
              };
              if (v instanceof SetFiles) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var event = Web_HTML_Event_DragEvent.toEvent(v.value0);
                      var eventTarget = Data_Maybe.fromJust()(Web_Event_Event.currentTarget(event));
                      var droppedFiles = Halogen_Media_Utils.fileListToFiles(Web_HTML_Event_DataTransfer.files(Web_HTML_Event_DragEvent.dataTransfer(v.value0)));
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(event)))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Halogen_Query_HalogenM.applicativeHalogenM)(function (x) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Data_UUID.genUUID))(function (v2) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_File_FileReader.fileReader))(function (v3) {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Data_Functor.map(Halogen_Query_EventSource.functorEventSource(((((dictMonadAff.MonadEffect0()).Monad0()).Bind1()).Apply0()).Functor0()))(HandleFileUpload.create(v2))(fileEventSource(v3))))(function (v4) {
                                          var blob = Web_File_File.toBlob(x);
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_File_FileReader.readAsDataURL(blob)(v3)))(function () {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Halogen_Media_Data_File.ExtendedFile(x, v2, Data_Maybe.Nothing.value));
                                          });
                                      });
                                  });
                              });
                          })(droppedFiles))(function (v2) {
                              var uploadFiles = Data_Functor.map(Data_Functor.functorArray)(function (v3) {
                                  return new Halogen_Media_Data_File.UploadFile(new Halogen_Media_Data_File.ExtendedFile(v3.value0, v3.value1, v3.value2), false);
                              })(v2);
                              var allFiles = Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1.files)(uploadFiles);
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  var $112 = {};
                                  for (var $113 in v3) {
                                  ...
                                  return Halogen_Query_HalogenM.raise(new DroppedFiles(v2));
                              });
                          });
                      });
                  });
              };
              if (v instanceof SubmitFiles) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var uploadFiles = Data_Functor.map(Data_Functor.functorArray)(function (v2) {
                          return new Halogen_Media_Data_File.ExtendedFile(v2.value0.value0, v2.value0.value1, v2.value0.value2);
                      })(v1.files);
                      return Halogen_Query_HalogenM.raise(new UploadFiles(uploadFiles));
                  });
              };
              throw new Error("Failed pattern match at Halogen.Media.Component.Upload (line 156, column 18 - line 214, column 40): " + [ v.constructor.name ]);
          };
          return Halogen_Component.mkComponent({
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Form.Submission"] = $PS["Form.Submission"] || {};
  var exports = $PS["Form.Submission"];
  ...
  var Halogen_HTML_Events = $PS["Halogen.HTML.Events"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var Halogen_Media_Component_Upload = $PS["Halogen.Media.Component.Upload"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Heterogeneous_Mapping = $PS["Heterogeneous.Mapping"];                
  var SubmissionForm = function (x) {
      return x;
  };
  var HandleUpload = (function () {
      function HandleUpload(value0) {
          this.value0 = value0;
      };
      HandleUpload.create = function (value0) {
          return new HandleUpload(value0);
      };
      return HandleUpload;
  })();
  var prx = function (dictRowToList) {
      return function (dictNewtype) {
          return function (dictMakeSProxies) {
              return Formless_Transform_Row.mkSProxies()(dictNewtype)(dictMakeSProxies)(Formless_Types_Form.FormProxy.value);
          };
      };
  };
  var newtypeSubmissionForm = new Data_Newtype.Newtype(function (n) {
      return n;
  }, SubmissionForm);
  var component = function (dictMonad) {
      return function (dictMonadAff) {
          var render = function (st) {
              var uploadComponent = Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "upload";
              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Halogen_Media_Component_Upload.component(dictMonadAff.MonadEffect0())(dictMonadAff))(Data_Unit.unit)(function ($19) {
                  return Data_Maybe.Just.create(Formless_Action.injAction(HandleUpload.create($19)));
              });
              return Halogen_HTML_Elements.form_([ Component_HTML_Utils.renderField("Full Name*")(Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueInput((function () {
                  var $20 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "fullName";
                  ...
                  return function ($21) {
                      return Data_Maybe.Just.create($20($21));
                  };
                  ...
                  var $22 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "pronoun";
                  }))(newtypeSubmissionForm)()((prx()(newtypeSubmissionForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "abstract";
                  }))()(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return function ($23) {
                      return Data_Maybe.Just.create($22($23));
                  };
                  ...
                  var $24 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "email";
                  }))(newtypeSubmissionForm)()((prx()(newtypeSubmissionForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "abstract";
                  }))()(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  var $26 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "phoneNumber";
                  }))(newtypeSubmissionForm)()((prx()(newtypeSubmissionForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "abstract";
                  }))()(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return Data_Maybe.Just.create(Formless_Action.modify(new Data_Symbol.IsSymbol(function () {
                      ...
                      return "website";
                  }))()(Formless_Transform_Row.makeSProxiesNil)))))))))))))).refund)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean)));
              }) ]))(Data_Maybe.Nothing.value), (function () {
                  var v = Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                      return "refund";
                  }))(newtypeSubmissionForm)()((prx()(newtypeSubmissionForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "abstract";
                  }))()(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  if (v) {
                      return Component_HTML_Utils.renderField("City of departure")(Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueInput((function () {
                          var $28 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                              return "airport";
                          }))(newtypeSubmissionForm)()((prx()(newtypeSubmissionForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                              return "abstract";
                          }))()(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          ...
                          return function ($29) {
                              return Data_Maybe.Just.create($28($29));
                          };
                      })()) ]))(Data_Maybe.Nothing.value);
                  };
                  if (!v) {
                  ...
                  throw new Error("Failed pattern match at Form.Submission (line 112, column 9 - line 118, column 32): " + [ v.constructor.name ]);
              })(), Component_HTML_Utils.renderField("Title")(Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueInput((function () {
                  var $30 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "title";
                  }))(newtypeSubmissionForm)()((prx()(newtypeSubmissionForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "abstract";
                  }))()(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return function ($31) {
                      return Data_Maybe.Just.create($30($31));
                  };
                  ...
                  var $32 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "abstract";
                  }))(newtypeSubmissionForm)()((prx()(newtypeSubmissionForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "abstract";
                  }))()(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return function ($33) {
                      return Data_Maybe.Just.create($32($33));
                  };
                  ...
                  var $34 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "airport";
                  }))(newtypeSubmissionForm)()((prx()(newtypeSubmissionForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "abstract";
                  }))()(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return function ($35) {
                      return Data_Maybe.Just.create($34($35));
                  };
              })()) ]))(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "bio";
              }))(newtypeSubmissionForm)()((prx()(newtypeSubmissionForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "website";
              }))()(Formless_Transform_Row.makeSProxiesNil)))))))))))))).bio)(st.form)), Component_HTML_Utils.renderField("Comment")(Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.rows(10), Halogen_HTML_Properties.cols(60), Halogen_HTML_Events.onValueInput((function () {
                  var $36 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "comment";
                  }))(newtypeSubmissionForm)()((prx()(newtypeSubmissionForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "abstract";
                  }))()(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return function ($37) {
                      return Data_Maybe.Just.create($36($37));
                  };
              ...
              }), Component_HTML_Utils.css("button") ])([ Halogen_HTML_Core.text("Submit") ]) ]) ]);
          };
          var input = {
              initialInputs: Data_Maybe.Nothing.value,
              validators: {
                  id: Formless_Validation.noValidation(dictMonad),
                  fullName: Form_Validation.validateStr(dictMonad),
                  pronoun: Form_Validation.validateStrMaybe(dictMonad),
                  refund: Formless_Validation.noValidation(dictMonad),
                  airport: Form_Validation.validateStrMaybe(dictMonad),
                  title: Form_Validation.validateStrMaybe(dictMonad),
                  "abstract": Form_Validation.validateStrMaybe(dictMonad),
                  bio: Form_Validation.validateStr(dictMonad),
                  comment: Form_Validation.validateStrMaybe(dictMonad),
                  email: Form_Validation.validateStr(dictMonad),
                  phoneNumber: Form_Validation.validateStr(dictMonad),
                  website: Form_Validation.validateStrMaybe(dictMonad)
              }
          };
          var handleEvent = function (v) {
              if (v instanceof Formless_Types_Component.Submitted) {
                  var fields = Formless_Transform_Record.unwrapOutputFields(newtypeSubmissionForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                      return "abstract";
                  ...
                  return Halogen_Query_HalogenM.raise(fields);
              };
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          };
          var handleAction = function (v) {
          ...
          return Formless_Component.component(dictMonadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "website";
              ...
              return "id";
          }))(Formless_Types_Form.eqInputField(Data_Submission.eqSubmissionId)))()(new Data_Symbol.IsSymbol(function () {
              return "fullName";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              return "email";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              ...
              return "abstract";
          }))(dictMonad)()(newtypeSubmissionForm)()()(Formless_Internal_Transform.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "airport";
          }))(dictMonad)()(newtypeSubmissionForm)()()(Formless_Internal_Transform.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "bio";
          }))(dictMonad)()(newtypeSubmissionForm)()()(Formless_Internal_Transform.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "website";
          }))(dictMonad)()(newtypeSubmissionForm)()()(Formless_Internal_Transform.applyToValidationNil(dictMonad))))))))))))))(Formless_Internal_Transform.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              return "abstract";
              ...
              return "id";
          }))(Data_Submission.initialSubmissionId)()(Formless_Transform_Row.mkInputFieldsFromRowCons(new Data_Symbol.IsSymbol(function () {
              return "phoneNumber";
          }))(Formless_Class_Initial.initialString)()(Formless_Transform_Row.mkInputFieldsFromRowCons(new Data_Symbol.IsSymbol(function () {
              return "pronoun";
          }))(Formless_Class_Initial.initialString)()(Formless_Transform_Row.mkInputFieldsFromRowCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "website";
          }))(Formless_Class_Initial.initialString)()(Formless_Transform_Row.mkInputFieldsFromRowNil)())())())())())())())())())())())())(newtypeSubmissionForm)(newtypeSubmissionForm)(newtypeSubmissionForm)(newtypeSubmissionForm)(newtypeSubmissionForm)(newtypeSubmissionForm)(newtypeSubmissionForm)(newtypeSubmissionForm)()()()()()()()()()(Data_Function["const"](input))({
              render: render,
              handleAction: handleAction,
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Page.Submission"] = $PS["Page.Submission"] || {};
  var exports = $PS["Page.Submission"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Ord = $PS["Data.Ord"];
  var Data_Symbol = $PS["Data.Symbol"];
  var Data_Unit = $PS["Data.Unit"];
  var Form_Submission = $PS["Form.Submission"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML = $PS["Halogen.HTML"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];                
  ...
  var HandleSubmission = (function () {
      function HandleSubmission(value0) {
          this.value0 = value0;
      };
      HandleSubmission.create = function (value0) {
          return new HandleSubmission(value0);
      };
  ...
  var component = function (dictMonad) {
      return function (dictMonadAff) {
          var render = function (state) {
              var submissionForm = Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "formless";
              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Form_Submission.component(dictMonad)(dictMonadAff))(Data_Unit.unit)(function ($7) {
                  return Data_Maybe.Just.create(HandleSubmission.create($7));
              });
              return Halogen_HTML_Elements.div([  ])([ submissionForm ]);
          };
          var handleAction = function (v) {
              if (v instanceof Initialize) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              };
              if (v instanceof HandleSubmission) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              };
              throw new Error("Failed pattern match at Page.Submission (line 45, column 18 - line 47, column 45): " + [ v.constructor.name ]);
          };
          return Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var Page_Submission = $PS["Page.Submission"];
  var Routing_Duplex = $PS["Routing.Duplex"];
  var Routing_Hash = $PS["Routing.Hash"];                
      ...
      return function (dictNavigate) {
          var render = function (v) {
              if (v.route instanceof Data_Maybe.Just && v.route.value0 instanceof Data_Route.Home) {
                  return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                      return "home";
                  }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Page_Home.component)(Data_Unit.unit)(Data_Void.absurd);
              };
              if (v.route instanceof Data_Maybe.Just && v.route.value0 instanceof Data_Route.Submission) {
                  return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                      return "submission";
                  }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Page_Submission.component((dictMonadAff.MonadEffect0()).Monad0())(dictMonadAff))(Data_Unit.unit)(Data_Void.absurd);
              };
              ...
              throw new Error("Failed pattern match at Component.Router (line 65, column 22 - line 71, column 59): " + [ v.route.constructor.name ]);
          };
          var handleQuery = function (v) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Route.eqRoute))(v1.route)(new Data_Maybe.Just(v.value0)))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $17.route = new Data_Maybe.Just(v.value0);
                      return $17;
                  })))(function () {
          ...
          var handleAction = function (v) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)((function () {
                  var $25 = Routing_Duplex.parse(Data_Route.routeCodec);
                  return function ($26) {
                      return Data_Either.hush($25($26));
                  };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      ...
      var rootComponent = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(AppM.runAppM(env))(Component_Router.component(AppM.monadAffAppM)(AppM.navigateAppM));
