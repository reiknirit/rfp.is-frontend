...
(function($PS) {
  ...
  var app = function (env) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)((function () {
          if (env instanceof Data_Environment.Development) {
              return Node_Express_App.useAt("/static")(Node_Express_Middleware_Static["static"]("static"));
          };
          return Control_Applicative.pure(Node_Express_App.applicativeAppM)(Data_Unit.unit);
      })())(function () {
          return Node_Express_App.get()("*")(Node_Express_Response.sendFile("static/views/index.html"));
      });
  };
  var main = Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Dotenv.loadFile)(function () {
      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
          var port = Node_Process.lookupEnv("PORTNR")();
          var env = Node_Process.lookupEnv("ENVIRONMENT")();
          var p = Data_Maybe.fromMaybe("8080")(port);
          var envStr = Data_Maybe.fromMaybe("Development")(env);
          return Node_Express_App.listenHttp(app(Data_Environment.toEnvironment(envStr)))(Data_Maybe.fromMaybe(8080)(Data_Int.fromString(p)))(function (v) {
